...
def inicializarVariables(codigo, password):
    ...
    chromedriver_path = 'C:\Users\Jesus Sosa\Desktop\python\evaluacion-final\chromedriver.exe'
...
def registrar_evento(matricula, direccion):
    try:
        ...
        query = """INSERT INTO ingresos_historial (matricula, direccion, fecha)
                   VALUES (%s, %s, %s)"""
...
if __name__ == '__main__':
    ...
    codigo = input("Ingresar la matricula: ")
